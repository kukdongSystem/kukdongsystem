...
export const dict: Translations = {
  ...
  project1Desc: { ko: 'Mitsubishi FX5U 및 GT25 HMI를 이용한 완전 자동화 공정 구축', en: 'Built fully automated process using Mitsubishi FX5U and GT25 HMI', zh: '使用三菱FX5U和GT25 HMI构建的全自动化流程', ja: '三菱FX5UおよびGT25 HMIを使用した完全自動化プロセス', de: 'Vollautomatisierter Prozess mit Mitsubishi FX5U und GT25 HMI' },
  ...
  project2Desc: { ko: '6축 다관절 로봇 및 비전 시스템 통합 정밀 제어 솔루션', en: '6-axis articulated robot and vision system integrated precision control solution', zh: '六轴关节机器人与视觉系统集成精密控制解决方案', ja: '6軸多関節ロボットとビジョンシステムの統合精密制御ソリューション', de: '6-Achsen-Knickarmroboter und Bildverarbeitungssystem integriert' },
  ...
  project3Desc: { ko: '공장 전체 가동 현황 실시간 모니터링 및 데이터 로깅 시스템', en: 'Real-time monitoring and data logging system for overall factory operation status', zh: '针对全厂运行状态的实时监控与数据记录系统', ja: '工場全体の稼働状況のリアルタイム監視とデータロギングシステム', de: 'Echtzeit-Überwachung und Datenprotokollierung für den Fabrikbetrieb' },
